...
-static-libgcc \
-lglew32 -lopengl32 \
-mms-bitfields -lfreetype -lbz2 -lz -lpng16 -lz -lharfbuzz -lfreetype -lm -lusp10 -lgdi32 -lrpcrt4 -ldwrite -lgraphite2 -lstdc++ -lglib-2.0 -lintl -lws2_32 -lole32 -lwinmm -lshlwapi -pthread -lm -lpcre -lbrotlidec-static -lbrotlicommon-static \
-lnng \
-lz \

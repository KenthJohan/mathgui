...
{
	GL_Texture    * texure = ecs_term (it, GL_Texture   , 1);
	GL_Tex2DArray * tex    = ecs_term (it, GL_Tex2DArray, 2);
...
{
	ECS_SYSTEM (world, system_texture_onset, EcsOnSet, GL_Texture, GL_Tex2DArray);
}
